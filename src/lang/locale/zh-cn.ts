...
export const zhCn: Record<MessageKey, string> = {
	...
	WS_TAB_GROUP_INTERACT_ARIA: '分组：{name}，可拖拽排序，右键打开菜单，可将工作区拖入',
	WS_TAB_GROUP_MENU_DELETE: '删除分组',
	WS_TAB_GROUP_MENU_RENAME: '重命名分组',
	WS_DELETE_TAB_GROUP_TITLE: '删除分组',
	WS_DELETE_TAB_GROUP_BODY: '删除分组「{name}」？该分组下的工作区将移入默认分组。',
	NOTICE_TAB_GROUP_DELETED: '已删除分组',
